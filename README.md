# chat-p2p
Chat p2p full-duplex feito em python para a disciplina de Redes de Computadores, da UFPB.

# TODO:
1. Proteção contra bruteforce de senha
2. ~~Conectar mais de 2 usuários por chat~~
